...
## Project Phase
**Phase 1 (current):** Data engineering foundation — problem definition,
data acquisition, inspection, cleaning, transformation, and exploratory
data analysis (EDA). Feature engineering and model development are out of
scope for this phase.

## Team
- [Your name]
- [Teammate 1]
- [Teammate 2]# Diabetes Risk Prediction — Data Engineering & ML Pipeline
